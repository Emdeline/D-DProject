...
public class ClassChoice
	{
		...
		public static void chooseClass()
			{
				// have to choose Game Name
				
				System.out.println("Let's start out with making your character's name.");
			...
			System.out.println(" ");
				...
				System.out.println("Thats an awesome name! ");
				
				// have to choose a Class
			System.out.println(" ");

				System.out.println(gameName + ", lets now choose your class.");
				...
				if (class1 == 1)
				...
				else if (class1 == 9)
					{
						System.out.println("One of the earth, a good-natured Druid!");
							System.out.println("A Druid is a priest of the Old Faith, weilding the powers of nature - moonlight and plant growth, fire, and lighting. They can also adopted animal forms! Okay, the is AWESOME! Nature is the best!");
