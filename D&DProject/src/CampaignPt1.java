...
public class CampaignPt1
	{
		static ArrayList <DandD> Enemy = new ArrayList <DandD>();
		...
		public static void campaignpt1()
			{
				...
				System.out.println("Hesitently, you still proceed on your journey. Then all of a sudden");
				System.out.println("You are jumped by a gnome.");
				System.out.println(" ");
				System.out.println("You have 2 choices: (1) Punch Him, (2) Run Away.");
				//please do not choose three
